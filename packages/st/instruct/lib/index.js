...
const FIELDS = [
	{
		disk: "system_sequence",
		key: "systemSequence"
	},
	{
		disk: "system_sequence_prefix",
		key: "systemSequencePrefix"
	},
	{
		disk: "system_sequence_suffix",
		key: "systemSequenceSuffix"
	},
	{
		disk: "input_sequence",
		key: "inputSequence"
	...
	{
		disk: "first_output_sequence",
		key: "firstOutputSequence"
	},
	{
		disk: "first_output_suffix",
		key: "firstOutputSuffix"
	},
	{
		disk: "last_output_sequence",
		key: "lastOutputSequence"
	},
	{
		disk: "last_output_suffix",
		key: "lastOutputSuffix"
	},
	{
		disk: "stop_sequence",
		key: "stopSequence"
	...
	{
		disk: "separator_sequence",
		key: "separatorSequence"
	},
	{
		disk: "wrap",
		key: "wrap"
...
var StInstructService = class extends Service {
	constructor(ctx) {
		super(ctx, "stInstruct");
	}
};
var StInstructFileProvider = class extends StInstructService {
	config;
	static inject = [];
	...
	async save(instruct) {
		...
		for (const { disk: field, key } of FIELDS) disk[field] = instruct.template[key];
...
const name = "st-instruct-file";
//#endregion
export { StInstructService, StInstructFileProvider as default, name };
