...
*/
var OpenRouterAdapter = class extends LlmAdapter {
	providerInfo() {
		return {
			id: PROVIDER,
			name: "OpenRouter"
	...
	async *stream(_options) {
		throw new LlmError("llm-openrouter: real OpenRouter SSE streaming is not yet implemented; use the 'custom' source (which routes through llm-deepseek's OpenAI-compatible adapter) for OpenRouter endpoints.", "NOT_IMPLEMENTED");
	}
};
/**
