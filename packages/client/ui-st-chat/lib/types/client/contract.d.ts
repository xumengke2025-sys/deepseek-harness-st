...
export declare const ST_REGEX_PLACEMENT: {
...
export interface StApi {
    ...
    getCharacter(avatar: string): Promise<{
        avatar: string;
        name: string;
        card: {
    ...
    importCharacterPng(dataUrl: string): Promise<{
        avatar: string;
    }>;
    /** Create a character from form fields; returns the new avatar file name. */
    createCharacter(form: StCharacterForm): Promise<{
        avatar: string;
    }>;
    ...
    renameCharacter(avatar: string, newName: string): Promise<{
        avatar: string;
    }>;
    ...
    exportCharacterPng(avatar: string): Promise<{
        png: string;
    }>;
    ...
    createChat(avatar: string, userName: string, characterName: string, firstMessage?: string): Promise<{
        chatId: string;
    }>;
    ...
    importChat(avatar: string, jsonl: string): Promise<{
        chatId: string;
    }>;
    ...
    checkpointChat(avatar: string, chatId: string, upto?: number): Promise<{
        chatId: string;
    }>;
    ...
    indexWorld(name: string): Promise<{
        indexed: number;
    }>;
